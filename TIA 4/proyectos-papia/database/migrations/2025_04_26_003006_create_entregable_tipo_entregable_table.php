...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $table->foreign('COD_entregable')->references('COD_entregable')->on('entregables')->onDelete('cascade');
        $table->foreign('COD_tipoentregable')->references('COD_tipoentregable')->on('tipo_entregables')->onDelete('cascade');
        });
    }
